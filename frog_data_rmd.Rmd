...
### Increasing enivornmental temperatures had a clear negative effect on the time taken for frogspawn to hatch (one-way ANOVA: F2,57 = 385.9, P < 0.001). At 13∘C the mean time to hatching was 26.3 days, this decreased by an average of 5.3 days at 18∘C and finally by 10.1 days at 25∘C.
...
```
### Figure 1: The time in days it takes for frogspawn to hatch in 13, 18 and 25°C temperatures. Thick horizontal line is the median with individual points displayed as a jitter.   